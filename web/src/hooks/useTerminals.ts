 ...
 * is not visible; ``false`` (no polling) the instant the agent terminal lands
 * or pending clears. A user shell does not satisfy the pending agent-terminal
...
export function terminalsReconcileInterval(
  ...
  return reconcileWhilePending && !agentTerminalAvailable
